...
-Add JWT authentication: Add functionalities to ensure users have logins and can only access their own data, and that certain endpoints are restricted to an admin class

-Additional Endpoints: Create more complex functions or add more customizability (i.e. an endpoint that would delete users and all orders related to the user). 
